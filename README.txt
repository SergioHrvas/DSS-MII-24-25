...
2. El carrito de compra se asocia al usuario cuando este se crea, excepto cuando se hace desde la consola de h2.
...
5. Aunque no era necesario para el problema planteado, he creado la clase Cart por facilitar escalabilidad en un futuro (teniendo en cuenta que si la aplicación se
